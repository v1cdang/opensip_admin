...
<form action="/addCustomer" method="POST">
    ...
    <div>
        <input id="name" name="name" class="element text medium" type="text" value="">
    </div>
    ...
    <div>
    <input id="prefix" name="prefix" class="element text medium" type="text" value="{{ $newPrefix }}" disabled size=4>
    </div>
